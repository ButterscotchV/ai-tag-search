...
class TypedPairDatabaseIterator<K, V>(db: PairDatabase, txn: Txn<DirectBuffer>, val keyConverter: DirectBufferConverter<K>, val valueConverter: DirectBufferConverter<V>) : Iterator<Pair<K, V>>, Closeable {
    ...
    override fun next(): Pair<K, V> {
        ...
        val value = valueConverter.read(nextRawPair.`val`(), 0)
